...
const navItems = [
  ...
  },
  {
    group: '渐变撞色风格',
    items: [
      { label: '不带验证码登录', to: '/gradient', icon: Sparkles },
      { label: '带验证码登录', to: '/gradient/captcha', icon: Sparkles },
      { label: '不带验证码注册', to: '/gradient/register', icon: Sparkles },
      { label: '带验证码注册', to: '/gradient/register/captcha', icon: Sparkles },
    ]
  },
  {
    group: '插画故事风格',
  ...
  },
  {
    group: '分屏品牌风格',
    items: [
      { label: '不带验证码登录', to: '/splitbrand', icon: Sparkles },
      { label: '带验证码登录', to: '/splitbrand/captcha', icon: Sparkles },
      { label: '不带验证码注册', to: '/splitbrand/register', icon: Sparkles },
      { label: '带验证码注册', to: '/splitbrand/register/captcha', icon: Sparkles },
    ]
  },
  {
    group: '毛玻璃弹窗风格',
  ...
  },
  {
    group: '复古像素风格',
    items: [
      { label: '不带验证码登录', to: '/retropixel', icon: Sparkles },
      { label: '带验证码登录', to: '/retropixel/captcha', icon: Sparkles },
      { label: '不带验证码注册', to: '/retropixel/register', icon: Sparkles },
      { label: '带验证码注册', to: '/retropixel/register/captcha', icon: Sparkles },
    ]
  },
  {
    group: '三维玻璃风格',
