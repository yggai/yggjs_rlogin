...
export const LoginForm: React.FC<LoginFormProps> = ({
  ...
  return (
    <div className={`yggjs-rlogin-form ${className || ''}`} style={style}>
      <h1 className="yggjs-rlogin-title">{title}</h1>

      <form onSubmit={handleSubmit}>
        {/* 用户名输入框 */}
        <div className="yggjs-rlogin-field">
          <div className="yggjs-rlogin-input-container">
            <input
              type="text"
              value={username}
          ...
          {errors.username && (
            <div className="yggjs-rlogin-form-error" role="alert">
              {errors.username}
            </div>
          )}
        </div>
