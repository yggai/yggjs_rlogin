...
import type { MinimalLoginPageProps } from '../types'
...
export const MinimalLoginPage: React.FC<MinimalLoginPageProps> = ({
  ...
  const containerClasses = [
    'yggjs-minimal-login-page',
    `yggjs-minimal-login-page--${colorScheme}`,
    className
  ].filter(Boolean).join(' ')
        ...
        <div className="yggjs-minimal-login-card">
          ...
          {(logo || title) && (
            <div className="yggjs-minimal-login-header">
              ...
              {title && !logo && (
                <h1 className="yggjs-minimal-login-title">{title}</h1>
              )}
            </div>
          )}
          ...
          <form className="yggjs-minimal-login-form" onSubmit={handleSubmit}>
            ...
            <div className="yggjs-minimal-login-field">
              <div className="yggjs-minimal-password-container">
                ...
                <button
                  type="button"
                  className="yggjs-minimal-eye-button"
